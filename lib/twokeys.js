...
(function() {
  ...
  Twokeys.prototype.Series = function(options) {
    ...
    if ((_base = this.data).original == null) {
      _base.original = Twokeys.prototype._randomSeries.apply(this, []);
    }
    return this;
  };
  ...
  Twokeys.prototype.Points = function(options) {
    ...
    this.data.original = options.data;
    if ((_base = this.data).original == null) {
      _base.original = Twokeys.prototype._randomPoints.apply(this, [this.count, this.dimension]);
    }
    return this;
  };
